        ...
        builder: (BuildContext context, _) {
          return CustomPaint(
            painter: _AuroraPainter(
              ...
              // A deep-space vertical gradient grounds the whole canvas: a
              // faint indigo glow up top falling to a near-black well below.
              baseTop: Color.alphaBlend(p.brand.withValues(alpha: p.isDark ? 0.10 : 0.05), p.canvas),
...
class _AuroraPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // 0) Deep-space base gradient — the "dark blue" foundation of the canvas.
    canvas.drawRect(
      rect,
      Paint()
    ...
    // Warm bloom — a fainter nebula of energy, lower and opposite-phase.
