...
## ζ1 — 2026-05-30
**Pulse Category:** 🌙 VEIL_PULSE *(10th pulse of v5; opens Pillar ζ — FLOW; chronic veil, distinct from ε3's acute)*
**The Surprise:** الدُّخول إلى وَضع التَركيز في v5 لا يُبنى بالإضافة بل يُكشَف بالطَرح. حين يُستَدعى `Upg.zen.enter(scope)` عند بَدء سيناريو تَدريبي، لا يَنبُت صُندوق modal في وَسَط الشاشة يُحاصِر العَين — بل **يَنحَسِر العالَم**. الـ dock لا يَختَفي بقَفزة `display:none`؛ **يَذوب** ببُطء (opacity إلى الصِفر، حالة مُزمِنة تَدوم طوال الجَلسة لا آنية كحِجاب ε3)، وفي الوَقت نَفسِه يَهبِط حِجاب بلَون الكانفس العَميق ذاتِه (`var(--canvas)` — داكِن في الليل، عاجِيّ في النهار، صادِق مع السِمَة) فوق كل شيء. ولا يُرفَع من تَحت هذا الحِجاب إلا المُهِمَّة الواحِدة المَقصودة: تُعَلَّم بـ `[data-zen-scope]` وتَصعَد إلى `--z-overlay` بَينَما الحِجاب يَستَقِر عند `--z-scrim`، فتَصير المُهِمَّة فُسحَة مُضاءة وكل ما سِواها طَيف. الطَبقات مُثبَتة بدِقَّة: `main` و`.bento` لا يُنشِئان سِياق تَكديس، أما البِطاقة فتُنشِئه (container-type) لكن z-index يُحسَب في السِياق الجِذر — فالرَفع يَعمَل بنَظافة، وقاعِدة الزِن (تَخصيص 0,3,0) تَتَفَوَّق على قاعِدة البِطاقة المُتَوَسِّعة (0,2,0) حتى تَرتَفِع البِطاقة المُتَوَسِّعة نَفسُها صَحيحةً. والدُّخول مَوقوت على أبطأ مُدَّة في النِظام (`--duration-zen` ٦٤٠ms) بـ `--ease-emerge` كنَفَسٍ مَحبوس. والحِجاب لا يَبلُغ العَتمة الكامِلة بل يَقِف عند 0.82: العالَم **حاضِر، لكنه مَكتوم** — يَبقى منه طَيف خَلف الفُسحَة، فلا يُلغى السِياق بل يُهَدَّأ.

**Reference Avoided:** Forbidden #5 (الـ modal popup — `position: fixed; inset: 0` كَسطح محتوى مَركزي). كان الدُّخول إلى مُهِمَّة سَيَفتَح في الأَعراف الشائِعة صُندوقاً مَركزياً يُحاصِر الشاشة؛ هنا الحِجاب طبقة تَعتيم مَسموحة (كالـ scrim) لا صُندوق محتوى. وكذلك Forbidden #15 (طبقة إرشاد/تَعليم طُفَيلية تَظهَر بلا استِدعاء): وَضع التَركيز لا يَظهَر من تِلقاء نَفسِه أبداً — يُستَدعى صَراحةً، ولا يُضيف شَيئاً إلى المَسرَح بل يَطرَح المُنازِع.
**Inspired-by:** Wild Card #2 — الفَراغ السالِب في مَوجة هوكوساي (the negative space of a Hokusai wave): العَمَل هو ما لم تَرسُمه الفُرشاة. المَوجة تُعَرَّف بالبَياض الذي حَولَها لا بالخَطّ وَحدَه؛ ووَضع التَركيز كذلك — المُهِمَّة تُضيء لأن كل ما سِواها انحَسَر، لا لأن شَيئاً أُضيف إليها.
**User-Visible:** yes — يُفتَح بزِرّ "ادخُل وَضع التَركيز" داخِل البِطاقة المِحوَرية المُتَوَسِّعة (`data-zen-open`)، أو برمجياً عَبر `Upg.zen.enter`. مَحسوس فَوراً: الـ dock يَذوب، العالَم يَنحَسِر تَحت حِجاب، والمُهِمَّة وَحدَها تَبقى مُضاءة. زِرّ خُروج هادِئ واحِد يَطلُع في الزاوية (inline-end) بَعد استِقرار الحِجاب بنَفَس، والضَغط على الحِجاب أو Escape يُعيد العالَم.
**Originality Self-Score:** 4/5 — أوضاع التَركيز/الزِن مَعروفة. الذي يَرفَعه إلى 4: (١) التَركيز **بالطَرح** — العالَم يَنحَسِر بَدَل ظُهور صُندوق؛ (٢) الحِجاب عند **0.82 لا عَتمة كامِلة** فيَبقى المُحيط طَيفاً حاضِراً (فَراغ هوكوساي السالِب)؛ (٣) **طَبقات نَظيفة مُتَحَقَّقة** تَرفَع المُهِمَّة وَحدَها فوق طبقة تَعتيم بتَخصيص يَتَفَوَّق على قاعِدة البِطاقة المُتَوَسِّعة؛ (٤) الدُّخول مَوقوت على أبطأ token كنَفَس، والمُدَد **مَقروءة من الـ tokens** لا مُختَرَعة؛ (٥) a11y صادِقة — التَركيز يَنتَقِل إلى المُهِمَّة ويَعود إلى المُحَفِّز، زِرّ الخُروج خارِج تَرتيب الـ tab حتى ينعَقِد الزِن، وEscape مُرَتَّب بَعد مُعالِج الـ overlay. لا أَدَّعي 5 لأن focus-by-dimming فِكرة مَعروفة؛ الأصالة في انضِباط الطَرح + نَظافة الطَبقات المُتَحَقَّقة.
**Files touched:** platform-v5/assets/css/zen.css (NEW 151) · platform-v5/assets/js/zen.js (NEW 206) · platform-v5/index.html (+veil + exit affordance + trigger + link + script) · prompts/v5/ζ1_ZEN_TRIGGER.md (NEW spec)
...
## η1 — 2026-05-30
**Pulse Category:** ⚡ SPRING_PULSE *(13th pulse of v5; opens Pillar η — KINESIS; 2nd-consecutive SPRING after ζ3, distinct in kind — see pivot note)*
**The Surprise:** قَبل η1 كان لكُل مُكَوِّن رَقمُه الخاص للضَغط — `0.99` للبِطاقة، `0.92` لزِرّ الإغلاق، `0.985` لعُنصُر لَوحة الأوامر، `0.98` للـ CTA — ثمانية أرقام `:active` مُتَناثِرة، كُلٌّ منها يَنكَمِش لَحظةَ الضَغط ثُمَّ **يَعود بِلا جَواب**: لا ارتِداد، لا استِقرار، لا نَفَس. η1 لا يَحذِف أيّاً منها؛ بل يَمُدّ تَحتَها كُلِّها **حَقلاً واحِداً مُشتَرَكاً** عَبر `:where(button, [role="button"], [data-press])` — وهي حيلة دَقيقة: `:where()` تُبقي التَخصيص عند **صِفر** (0,0,0)، فلا تُزاحِم قاعِدة أيّ مُكَوِّن بل تَملأ الفَراغ بَينَها فَقَط. وما يُضيفه هذا الحَقل هو ما لم يَملِكه أيُّ زِرّ: **زُنبُرك الإفلات**. عند رَفع الإصبَع يُختَم العُنصُر بـ `[data-press-release]` لِدَورة واحِدة فتَجري `@keyframes press-bloom` (ثلاث مَحَطّات: من `--press-from` ← 1.014 ← 1.000) على `--ease-spring` — تَجاوُز واحِد ثُمَّ سُكون. والمُفاجَأة الأعمَق أن **عُمق الضَغط نِسبيّ بكُتلَة العُنصُر**: `press.js` يَقرأ `offsetHeight` لَحظةَ النُزول ويَضَع `--press-from` بَين `0.992` للعُنصُر الصَغير و`0.965` للعُنصُر الكَبير، فالـ CTA الضَخم يَرتَدّ من انضِغاط أعمَق من الرُقاقة الصَغيرة — حتى يَشعُر الإصبَع أنهما هَبَطا المَسافة الفيزيائية نَفسَها. هذا هو مُودُولور لو كوربوزييه: النِسبة مَربوطة بالجِسم لا بمِقدار ثابِت. وفَوق ذلك يُطلِق الحَقل `upg:press` على كل تَفعيل — فتَستَطيع η3 (الهَدهَدة اللَمسية) أن تَعقُد نَبضةَ «دفّن» عليه دون أن يَعتَمِد `press.js` على الـ haptic أصلاً.

**Reference Avoided:** الـ AI-default الأكبر للأزرار: «scale(0.98) مُوَحَّد أو مُتَناثِر على كُلّ زِرّ، بِلا فيزياء إفلات» — كل مُكَوِّن يَخترِع رَقماً ويَكتَفي بانكِماشٍ يَموت عند الرَفع. وكذلك MOTION §6.5 (تَحوُّلات الـ hover فوق 4px مَمنوعة): الجَواب هنا على **الضَغط لا الـ hover**، وبالنِسبة لا بالقَفز.
**Inspired-by:** Wild Card #3 — مُودُولور لو كوربوزييه (Le Corbusier's Modulor): نِظام نِسَب مَربوط بأبعاد الجِسم البَشَري. عُمق الانضِغاط هنا يَتناسَب مع كُتلَة العُنصُر تماماً كما تَشتَقّ مَقاسات المِعمار من قامَة الإنسان ويَدِه.
**User-Visible:** yes — مَحسوس على كل زِرّ في المِنصَّة فَوراً: يَنزِل عند الضَغط ويَرتَدّ بزُنبُركٍ خَفيف عند الإفلات، والأزرار الكَبيرة تَهبِط أعمَق. مَن يُفَضِّل تَقليل الحَرَكة لا يَرى زُنبُركاً البَتَّة — يَرى خُفوتَ شَفافية (`opacity: 0.82`) يُقِرّ بالضَغط دون أي تَحَرُّك (MOTION §4.3). على اللَمس وسَطح المَكتب ولَوحة المَفاتيح (Enter/Space) مَعاً.
**Originality Self-Score:** 4/5 — تَغذية الضَغط الراجِعة فِكرة شائِعة. الذي يَرفَعها إلى 4: (١) **التَوحيد بصِفر تَخصيص** — `:where()` يَجمَع ثمانية أرقام مُتَناثِرة في طَبقة واحِدة دون أن يَكسِر أيّاً منها؛ (٢) **زُنبُرك الإفلات** الذي لم يَملِكه أيُّ مُكَوِّن — الجَواب على الرَفع لا على الضَغط؛ (٣) **العُمق النِسبيّ بالكُتلَة** (مُودُولور) بَدَل `scale(0.98)` المُوَحَّد — مَقروء من `offsetHeight`؛ (٤) **بِلا token مُدَّة جَديد** ولا `!important`؛ (٥) `upg:press` كحَدَث دَلالي يَفصِل الحَرَكة عن اللَمس فتَعقِد η3 الهَدهَدة بِلا تَبَعية. لا أدَّعي 5 لأن الـ press-spring مَعروف؛ الأصالة في انضِباط الصِفر-تَخصيص + النِسبة المُودُوليّة.
**Distinction (pivot compliance):** ε2 SPRING كان فيزياء سَحب (rubber-band بعَتَبة سُرعة/مَسافة)؛ ζ3 SPRING كان ازدِهارةَ اكتِمال لَقطة واحِدة على الحَلقة؛ η1 SPRING **مُستَمِرّ وعامّ** — ضَغط كل عُنصُر مع ارتِداد نِسبيّ. نَفس عائِلة الـ `--ease-spring`، مَحاور مُختَلِفة (سَحب / اكتِمال / ضَغط). ζ3→η1 هو ثاني SPRING مُتَتالٍ، لذا **η2 مُلزَمة بالانعِطاف** بَعيداً عن SPRING (→ HAPTIC). التَسَلسُل …VEIL·GLOW·SPRING·SPRING — لا فِئة ثلاثَ مَرّات مُتَتالية.
**Files touched:** platform-v5/assets/css/press.css (NEW 95) · platform-v5/assets/js/press.js (NEW 150) · platform-v5/index.html (+2 wiring) · prompts/v5/η1_PRESS_FEEDBACK.md (NEW spec)
**Verified at commit:** `d816240`
